  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        nature: "bg-gradient-nature text-primary-foreground hover:shadow-nature hover:scale-105 transition-bounce shadow-lg",
        adventure: "bg-gradient-adventure text-secondary-foreground hover:shadow-adventure hover:scale-105 transition-bounce shadow-lg",
        glass: "bg-white/20 backdrop-blur-md border border-white/30 text-foreground hover:bg-white/30 transition-smooth shadow-glass",
      },
      size: {
